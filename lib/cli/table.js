...
module.exports = {
	...
	createDownloadShowTable: function ( items ) {
		...
		var filteredItems = _.where(items, { verified: 1 }).sort(function ( a, b ) {
	...
	createDownloadSubtitleTable: function ( items ) {
		...
		var filteredItems = items.sort(function ( a, b ) {
			return a.raw.stats.downloads > b.raw.stats.downloads ? -1 : 1;
		});
